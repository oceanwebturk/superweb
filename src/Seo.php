...
class Seo
{
 ...
 public static function generate()
 {
  ...
  <link rel="shortcut icon" href="'.self::defaultControl('favicon').'"><meta property="og:image" content="'.self::defaultControl(['og:image','favicon']).'"><meta property="twitter:card" content="'.self::defaultControl('twitter:card','summary').'"><meta property="twitter:site" content="@'.(isset(self::$data['twitter:site']) ? self::$data['twitter:site'] : str_replace(['.',':','w'],'',URL::host())).'">
